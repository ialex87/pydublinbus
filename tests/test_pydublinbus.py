"""
Dublin Bus RTPI REST API client tests
"""
...
def test_raw_rtpi_data_is_dict():
    """Test if API response is a dictionary"""
...
def test_bus_timetable_without_route():
    """Test if 'bus_timetable' method return expected values"""
    dublinbus = DublinBusRTPI("312")
...
def test_bus_timetable_with_route():
    """Test if 'bus_timetable' method return expected values filtering by route"""
...
def test_bus_timetable_no_results():
    """Test if 'bus_timetable' method return no values"""
    dublinbus = DublinBusRTPI("312", "67")
